...
public:
    ...
    // virtual void HandlerJointCmd(const drdds::msg::JointsDataCmd::SharedPtr msg) = 0;
    // virtual void SetJointCommand(const drdds::msg::JointsDataCmd::SharedPtr msg) = 0;
    virtual void PublishJointData() = 0;
    virtual void PublishImuData() = 0;
};
